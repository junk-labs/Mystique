...
namespace Mystique.Views.Chrome
{
    public sealed class ButtonChromeEx : Decorator
    {
        ...
        public static readonly DependencyProperty DisableInnerBorderProperty = DependencyProperty.Register("DisableInnerBorder", typeof(bool), typeof(ButtonChromeEx), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
            ...
            get
            {
                if (_commonDisabledBackgroundOverlay == null)
                {
                    lock (_resourceAccess)
                    {
                        if (_commonDisabledBackgroundOverlay == null)
                        {
                            _commonDisabledBackgroundOverlay = new SolidColorBrush(Color.FromRgb(0xf4, 0xf4, 0xf4)).CloneFreeze();
                        }
                    }
                }
